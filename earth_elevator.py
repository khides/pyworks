...
#plt.xlim(0,an)
#for i in range(0,an):
#    tilist=np.arange(0,i,100)
#    xsubs2=[]
#    for j in range(len(tilist)):
#        xsubs2.append(float(xresult.subs(t,tilist[j])))    
#    im=plt.plot(tilist,xsubs2)
#    ims.append(im)
#anim=ani.ArtistAnimation(fig,ims,interval=10)
#plt.show()