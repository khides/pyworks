        ...
        if os.path.exists(log_file):
            ...
            try:
                with open(log_file, mode="w") as f:
                    ...
                    writer.writerow(["Timeinfo","Message", "Distance", "Relative Altitude", "Absolute Altitude", "Latitude", "Longitude"])
                    pass
...
def log_format(message = 'Nan', distance = 'Nan' ,
               relative_altitude = "Nan", absolute_altitude = "Nan", latitude = "Nan", longitude = "Nan"):
